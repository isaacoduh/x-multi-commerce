...
<div class="page-content">
				...
				<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
					<div class="breadcrumb-title pe-3">Edit Area </div>
					<div class="ps-3">
...
<div class="col-lg-10">
 ...
 <form id="myForm" method="post" action="{{ route('area.update') }}"   >
			@csrf
	 	...
	 	<select name="state_id" class="form-select mb-3" aria-label="Default select example">
		 	...
		 	<option value="{{ $item->id }}" {{ $item->id == $area->state_id ? 'selected' : ''  }} >{{ $item->state_name }}</option>
		 	@endforeach
